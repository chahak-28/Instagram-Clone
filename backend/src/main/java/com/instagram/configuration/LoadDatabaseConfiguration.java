...
import com.instagram.features.authentication.repository.AuthenticationUserRepository;
import com.instagram.features.authentication.utils.Encoder;
import com.instagram.features.feed.model.Post;
import com.instagram.features.feed.repository.PostRepository;
...
public class LoadDatabaseConfiguration {
    ...
    private List<AuthenticationUser> createUsers(AuthenticationUserRepository authenticationUserRepository) {
        List<AuthenticationUser> users = List.of(
        		createUser("aarav.patel1996@example.com", "aarav", "Aarav", "Patel","https://images.unsplash.com/photo-1607746882042-944635dfe10e?q=80&w=3600&auto=format&fit=crop"),
        		createUser("priya.sharma84@example.com", "priya", "Priya", "Sharma", "https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?q=80&w=3600&auto=format&fit=crop"),
        		createUser("rohit.iyer01@example.com", "rohit", "Rohit", "Iyer", "https://images.unsplash.com/photo-1544725176-7c40e5a2c9f9?q=80&w=3600&auto=format&fit=crop"),
        		createUser("nisha.gupta.art@example.com", "nisha", "Nisha", "Gupta", "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?q=80&w=3600&auto=format&fit=crop"),
        		createUser("amar.singh.del@example.com", "amar", "Amar", "Singh", "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=3600&auto=format&fit=crop")
    ...
    private AuthenticationUser createUser(String email, String password, String firstName, String lastName, String profilePicture) {
