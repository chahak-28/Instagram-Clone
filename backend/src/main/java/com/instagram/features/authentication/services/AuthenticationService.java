package com.instagram.features.authentication.services;
...
import com.instagram.features.authentication.dto.AuthenticationRequestBody;
import com.instagram.features.authentication.dto.AuthenticationResponseBody;
...
import com.instagram.features.authentication.utils.EmailService;
import com.instagram.features.authentication.utils.Encoder;
import com.instagram.features.authentication.utils.JsonWebToken;
...
public class AuthenticationService {
    ...
    public void sendEmailVerificationToken(String email) {
        ...
        if (user.isPresent() && !user.get().getEmailVerified()) {
            ...
            String body = String.format("Only one step to take full advantage of Instagram.\n\n"
    ...
    public AuthenticationResponseBody register(AuthenticationRequestBody registerRequestBody) {
        ...
        String body = String.format("""
                        Only one step to take full advantage of Instagram.
	...
	public AuthenticationUser updateUserProfile(Long userId, String firstName, String lastName) {
